    ...
    var t = {
                ...
                if (!h || !d || ("replace" === t && !l) || ("split" === t && !f)) {
                    var v = /./[p],
                        g = e(a, p, ""[t], function (t, n, e, r, o) {
                            return n.exec === c ? (h && !o ? { done: !0, value: v.call(n, e, r) } : { done: !0, value: t.call(e, n, r) }) : { done: !1 };
                        }),
                        y = g[0],
                        b = g[1];
        ...
        2923: function (t, n, e) {
            ...
            t.exports = function (t, n, e, g, y, b, m) {
                ...
                if (
                    (_ && (w = l(_.call(new t()))) !== Object.prototype && w.next && (u(w, j, !0), r || "function" == typeof w[f] || a(w, f, v)),
                        k &&
                        P &&
                        P.name !== d &&
                        ((A = !0),
                    ...
                    if (((x = { values: k ? L : O(d), keys: b ? L : O(h), entries: T }), m)) for (S in x) S in E || i(E, S, x[S]);
                ...
                "Array",
                {
                    from: function (t) {
                        var n,
                            ...
                            y = 0,
                            b = l(p);
                        if ((g && (v = r(v, d > 2 ? arguments[2] : void 0, 2)), null == b || (h == Array && s(b)))) for (e = new h((n = c(p.length))); n > y; y++) u(e, y, g ? v(p[y], y) : p[y]);
                        else for (f = b.call(p), e = new h(); !(o = f.next()).done; y++) u(e, y, g ? a(f, v, [o.value, y], !0) : o.value);
                        return (e.length = y), e;
                    },
                }
            );
            ...
            var r = e(3816),
                ...
                K = function (t, n, e) {
                    return (
                        ...
                        (n = w(n, !0)),
                        b(e),
                        o(D, n) ? (e.enumerable ? (o(t, q) && t[q][n] && (t[q][n] = !1), (e = j(e, { enumerable: O(0, !1) }))) : (o(t, q) || _(t, q, O(1, {})), (t[q][n] = !0)), H(t, n, e)) : _(t, n, e)
                    );
                },
                Q = function (t, n) {
                    b(t);
        ...
        7025: function (t, n, e) {
            !(function (t) {
                ...
                var n,
                    ...
                    w = x ? t.require : null,
                    O = { protocol: "protocol", host: "hostname", port: "port", path: "pathname", query: "search", hash: "hash" },
                ...
                function L(t, n) {
                    !(function (t, n, e) {
                        ...
                        var v,
                            g,
                            y = ((g = { path: !0, query: !0, hash: !0 }), (v = n) && r.test(v) && ((g.protocol = !0), (g.host = !0), o.test(v) && (g.port = !0), i.test(v) && ((g.user = !0), (g.pass = !0))), g);
                        for (h in ((d = n.match(i) || []), O)) y[h] ? (t[h] = a[O[h]] || "") : (t[h] = "");
                        if (
                            ((t.protocol = t.protocol.replace(s, "")),
                ...
                (P.prototype.toString = function () {
                    ...
                    (L.prototype.toString = function () {
                        return (
                            ...
                            (this.user && A(this.user) + (this.pass && ":" + A(this.pass)) + "@") +
                            (this.host && this.host) +
                            (this.port && ":" + this.port) +
                            (this.path && this.path) +
    ...
    (e.n = function (t) {
        ...
        (function () {
            ...
            var o = new (e.n(t)())(),
                i = "appstack-config-",
                a = ".js-settings",
                s = { theme: "default", layout: "fluid", sidebarPosition: "left", sidebarBehavior: "sticky" },
                c = { theme: ["default", "colored", "dark", "light"], layout: ["fluid", "boxed"], sidebarPosition: ["left", "right"], sidebarBehavior: ["sticky", "fixed", "compact"] },
                u = void 0,
                l = function () {
                ...
                g = function (t, n) {
                    if ("theme" === t) {
                        ...
                        document.querySelector(".js-stylesheet").setAttribute("href", "/Content/css/".concat(e, ".css")), u && u !== e && window.location.replace(window.location.pathname), (u = e);
                    }
                    document.body.dataset[t] = n;
                },
                y = function () {
                    return { theme: m("theme"), layout: m("layout"), sidebarPosition: m("sidebarPosition"), sidebarBehavior: m("sidebarBehavior") };
                },
                b = function () {
